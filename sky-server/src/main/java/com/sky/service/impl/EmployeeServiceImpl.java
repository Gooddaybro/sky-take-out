...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public Employee login(EmployeeLoginDTO employeeLoginDTO) {
        ...
        //新添加：对前端传过来的密码进行md5加密处理，已将数据库admin用户密码改成
        // “e10adc3949ba59abbe56e057f20f883e”（即将原密码“123456”进行md5信息摘要算法加密）
        password = DigestUtils.md5DigestAsHex(password.getBytes());//新加的代码
